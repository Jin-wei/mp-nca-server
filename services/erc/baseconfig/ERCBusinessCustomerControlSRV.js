...
const logger = require('../../../util/Logger').createLogger('ERCBusinessCustomerControlSRV');
...
async function initAct(req, res) {
    ...
    returnData.settletInfo = GLBConfig.SETTLEMENTWAY;
    const [admin, institution, headOffice, ...otherType] = GLBConfig.DOMAINTYPE;
