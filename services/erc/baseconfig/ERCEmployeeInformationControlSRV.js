...
async function initAct(req, res) {
    ...
    try{
        ...
        returnData.contractInfo = GLBConfig.CONTRACT;
        returnData.userStation = GLBConfig.USERSTATION;
        returnData.departureReason = GLBConfig.DEPARTUREREASON;
        returnData.registerCategory = GLBConfig.REGISTERCATEGORY;
        returnData.educationInfo = GLBConfig.EDUCATION;
        returnData.maritalStatus = GLBConfig.MARITALSTATUS;
        returnData.contractState = GLBConfig.CONTRACTSTATE;
        returnData.nationalInfo = GLBConfig.NATIONAL;
        returnData.acceptanceInfo = GLBConfig.ACCEPTANCETYPE;
        returnData.sortingInfo = GLBConfig.SORTINGWAY;
